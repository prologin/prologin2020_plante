...
extern "C" int api_score(int id_jardinier) { return api->score(id_jardinier); }
...
extern "C" void api_afficher_plante(plante v) { api->afficher_plante(v); }
...
extern "C" void api_afficher_erreur(erreur v) { std::cerr << v << std::endl; }
...
extern "C" void api_afficher_plante(plante v) { std::cerr << v << std::endl; }
