...
typedef enum erreur {
  ...
  TROP_LOIN, ///< Rayon de dépotage trop petit pour dépoter sur la case ciblée
} erreur;
...
typedef struct plante {
  ...
  int rayon_deplacement; ///< Distance maximale parcourable par la plante en
                         ///< creusant
...
typedef struct action_hist {
  ...
  position position_baffante; ///< Position de la plante baffante (si type
                              ///< d'action ``action_baffer``)
  position position_baffee; ///< Position de la plante baffée (si type d'action
                            ///< ``action_baffer``)
  position position_depart; ///< Position de la plante à déplacer (si type
                            ///< d'action ``action_depoter``)
  position position_arrivee;    ///< Position où déplacer la plante (si type
                                ///< d'action ``action_depoter``)
  position position_plante;     ///< Position de la plante  (si type d'action
                                ///< ``action_arroser``)
  caracteristique amelioration; ///< Caractéristique à améliorer (si type
